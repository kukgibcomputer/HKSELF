...
RfuBot=[lineMID]
Family=["ubea7d9116ec699c539f64065919bac7a",lineMID]
admin=['ubea7d9116ec699c539f64065919bac7a',lineMID]
...
settings = {
    ...
    "unsendMessage": False,
    "autoJoinTicket": True,
    "welcome":"🌹ยินดีต้อนรับเข้ากลุ่ม🌹\n\n🍭กลุ่มนี้น่ารักทุกคน🍭\n\n🐥เข้ามาแล้วอย่ารีบออกน้า🐥\n\n🌷 อยู่เป็นเพื่อนกันก่อน 🌷\n\n 💗 มีอะไรอ่านที่โน๊ตได้เลยนะ 💗\n\n⊱•══𖥦•⍣✾ʕ•̫͡ʕ•̫͡•ʔ̫͡•ʔ✾⍣•𖥦══•⊰\n http://line.me/ti/p/~botja\n⚔คนติดบอท⚔",
    "kick":"เตะสมาชิกทำไมเหรอ😂\n⚔คนติดบอท⚔",
    "bye":"🌠ออกแล้วเหรอจ๊ะ🌠\n🖐ไว้พบกันใหม่นะ 🖐\n✨🇬 🇴 🇴 🇩 🇧 🇾 🇪✨\n🌟。❤。😉。🍀。😝。❇️\n http://line.me/ti/p/~botja\n⚔คนติดบอท⚔",
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "📣〘ดำเนินการเรียบร้อย〙📣\n\n『✮ ⚔คนติดบอท⚔ ✮』" +datetime.today().strftime('%H:%M:%S')+ "™")
                    restartBot()
                elif text.lower() == 'ออน':
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    line.sendMessage(to, "⚔คนติดบอท⚔\n {}".format(str(runtime)))
...
#===========
                    ...
                    line.sendMessage(to,"📣〘ความเร็วยังปกติดี〙📣\n『✮ 【 ⚔คนติดบอท⚔ 】 ✮』" +datetime.today().strftime('%H:%M:%S')+ "™")
#===========
                    ...
                    line.sendMessage(to,"📣〘บอทยังคงทำงานปกติ〙📣\n『✮ 【 ⚔คนติดบอท⚔ 】 ✮』" +datetime.today().strftime('%H:%M:%S')+ "™")       
#==============================================================================#
                elif "n" == msg.text.lower():
                    msg.contentType = 13
                    line.sendMessage(to, "=========================")
                    line.sendContact(to, "ud44e99a716356489e15555af341936a0")
                    line.sendMessage(to, "=========================")
#===========
...
#==============================================================================#
                    ...
                    line.sendMessage(to,"CREATOR ⚔คนติดบอท⚔\n(｡◕‿◕｡)")
                    line.sendContact(to, "ud44e99a716356489e15555af341936a0")
...
#===================================================================#              
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"สั่ง (มอง) แล้วสั่ง (ใครอ่าน) \n(^人^) ")                
#==============================================================================#
#=============================================#                    
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "⚔คนติดบอท⚔\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
